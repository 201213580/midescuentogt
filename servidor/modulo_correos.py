...
def enviar_recuperacion(nombre,usuario,correo,contra):
    from_address = "chileroyrustico@gmail.com"
    to_address = correo
                            ...
                            <tr>
                                <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                                Si no haz solicitado tus datos de usuario por favor comunicate con nosotros soporte-micupongt@gmail.com y con gusto te ayudaremos.
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;">
                                                ...
                                                <br/> 
                                                Correo: soporte-micupongt@gmail.com
                                            </td>
                                            <td>
                                                <td align="right">
    ...
    smtp.quit()
def enviar_correo(usuario,contra):
    from_address = "chileroyrustico@gmail.com"
    to_address = "manuel13580@gmail.com"
    message = """<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                <html xmlns="http://www.w3.org/1999/xhtml">
                    <head> 
                        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
